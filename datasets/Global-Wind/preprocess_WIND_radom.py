...
# data path
data_line = "datasets/"
data_name = "Global-Wind"
data_file_path = data_line + data_name + "/" + data_name + ".csv"
...
def random_mask_matric_all(data, mask_percentage):
...
matric_25,_ = feature_target(random_mask_matric_all(data_new, 0.25),history_seq_len, future_seq_len)
matric_50,_ = feature_target(random_mask_matric_all(data_new, 0.5),history_seq_len, future_seq_len)
matric_75,_ = feature_target(random_mask_matric_all(data_new, 0.75),history_seq_len, future_seq_len)
matric_90,_ = feature_target(random_mask_matric_all(data_new, 0.9),history_seq_len, future_seq_len)
